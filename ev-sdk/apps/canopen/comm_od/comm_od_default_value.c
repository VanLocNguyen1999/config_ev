...
/*  */
#define DEFAULT__1008__DEVICE_NAME						{'S','E','L','E','X','_','H','M','I'}	/*(12 byte)*/

#define DEFAULT__1009__HW_VERSION						0x00000000			/*(32 bit)*/
#define DEFAULT__100A__SW_VERSION						0x00000000			/*(32 bit)*/
...
/* SDO client */
#define DEFAULT__103200__SDO_CLI_SYNC_TRANS_TYPE			(5)					//<< Set according to synchronous scheduled
																			//   Set 0 if you want disable sync mode, switch to always communication mode
#define DEFAULT__103201__SDO_CLI_SYNC_MASK_REGISTER		(0xFFFFFFFF)		//<< Set according to synchronous scheduled, default: 0x00000000
...
#define DEFAULT__180001__TPDO1_TRANS_TYPE					(07)				//<< Set according to synchronous scheduled.
