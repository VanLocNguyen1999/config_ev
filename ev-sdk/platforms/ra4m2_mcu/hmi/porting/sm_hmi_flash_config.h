...
#define SM_STORAGE_EV_BACKUP_ODO_FLASH_ADDR     FLASH_HP_DF_BLOCK_0     //Data block 0 - 64 bytes
#define SM_STORAGE_EV_BACKUP_ODO_FLASH_SIZE     4
...
#define SM_HMI_FW_SIGNATURE_FLASH_ADDR		    FLASH_HP_DF_BLOCK_19    //Data block 19 - 64 B
#define SM_HMI_FW_SIGNATURE_FLASH_SIZE          64


#define SM_HMI_TEST_INFO_FLASH_ADDR             FLASH_HP_DF_BLOCK_9
#define SM_HMI_TEST_INFO_FLASH_SIZE             64


//Exflash config

#define SM_HMI_SSL_CA_CERT_STORAGE_ADDR             0x000000U
#define SM_HMI_SSL_CA_CERT_STORAGE_SIZE             (4*1024)

#define SM_HMI_SSL_CLIENT_CERT_STORAGE_ADDR         0x001000U
#define SM_HMI_SSL_CLIENT_CERT_STORAGE_SIZE         (4*1024)

#define SM_HMI_SSL_CLIENT_KEY_STORAGE_ADDR          0x002000U
#define SM_HMI_SSL_CLIENT_KEY_STORAGE_SIZE          (4*1024)

#define SM_HMI_MAINAPP_FW_STORAGE_ADDR			    0x010000U
#define SM_FW_NEW_HMI_STORAGE_SIZE                  (388*1024)

#define SM_HMI_HEX_FILE_STORAGE_ADDR			    0x071000U
#define SM_FW_DOWNLOADED_STORAGE_SIZE               (572*1024)

#define SM_HMI_DEFAULT_MAINAPP_ADDR                 0x10000
